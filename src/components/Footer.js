      ...
      <footer className="bg-black">
        <div className="px-24 py-14 flex gap-12">
            <div className="flex flex-col text-white">
                <p className="text-xl font-Baskerville pb-4">SHOP</p>
            ...
            <div className="flex flex-col text-white">
                <p className="text-xl font-Baskerville pb-4">DESIGN</p>
                <p className="text-xs py-1">Suits</p>
                <p className="text-xs py-1">Shirts</p>
                <p className="text-xs py-1">Jackets</p>
                <p className="text-xs py-1">Pants</p>
            ...
            <div className="flex flex-col text-white">
                <p className="text-xl font-Baskerville pb-4">ABOUT</p>
            ...
            <div className="flex flex-col text-white">
                <p className="text-xl font-Baskerville pb-4">SUPPORT</p>
            ...
            <div className="flex flex-col text-white">
                <p className="text-xl font-Baskerville pb-4">SHOWROOMS</p>
                <p className="text-xs py-1">xyz</p>
                <p className="text-xs py-1">xyz</p>
                <p className="text-xs py-1">xyz</p>
                <p className="text-xs py-1">xyz</p>
                <p className="text-xs py-1">xyz</p>
            ...
            <div className="flex flex-col text-white">
                <p className="text-xl font-Baskerville pb-4">CUSTOMER SUPPORT</p>
