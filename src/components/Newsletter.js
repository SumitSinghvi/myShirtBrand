...
export default function Newsletter() {
  return (
    <div className="flex flex-col justify-center items-center py-32 bg-gray-100">
        <p className="font-Baskerville text-3xl text-gray-500 py-4">Receive $50 Off* Your First Order</p>
        <p className="font-Baskerville text-xm text-gray-500 pb-12">Subscribe to out newsletter</p>
        <form action="#" method="POST">
            <div className="mb-4 flex">
              ...
              <button type="submit" className="bg-black hover:text-red-500 text-white font-Baskerville py-2 px-4 focus:outline-none focus:shadow-outline">Subscribe</button>
            </div>
        </form>
